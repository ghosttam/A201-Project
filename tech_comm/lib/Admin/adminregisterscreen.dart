...
class _RegisterScreenState extends State<RegisterScreen> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 5),
                      Text("Click image to take merchant picture",
                          style:
  ...
  void _onRegister() async {
    ...
    await pr.show();
    http.post(
        "https://steadybongbibi.com/techcomm/php/PHPMailerMerchant/index.php",
        body: {
          "name": _name,
          "email": _email,
          "phone": _phone,
  ...
  void newRestaurantDialog() {
    ...
    if (_image == null) {
      Toast.show("Merchant picture empty!.", context,
